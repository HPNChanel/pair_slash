...
- No CI validation currently enforces issue template/schema drift against taxonomy docs.
- Existing `docs/support/phase-7-support-ops.md` and new `docs/support/triage-playbook.md` can drift without periodic sync.
...
- Add issue-form validation in CI to detect missing required fields or taxonomy drift.
