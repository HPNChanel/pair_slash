...
- Support intake routing flow: `docs/support/triage-playbook.md`
...
- Keep `docs/maintainers/README.md` and `docs/maintainers/pack-lifecycle-checklist.md` aligned with this playbook.
