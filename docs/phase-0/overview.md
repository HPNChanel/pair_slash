...
| Memory record schema | `phase-0/schemas/memory-record.schema.yaml` | JSON Schema for all 11 semantic fields |
| pairslash-plan spec | `phase-0/specs/pairslash-plan.spec.yaml` | Formal workflow contracts |
| pairslash-memory-write-global spec | `phase-0/specs/pairslash-memory-write-global.spec.yaml` | Formal workflow contracts + 11-step pipeline |
| pairslash-plan SKILL.md | `phase-0/skills/pairslash-plan/SKILL.md` | Working skill definition |
| pairslash-memory-write-global SKILL.md | `phase-0/skills/pairslash-memory-write-global/SKILL.md` | Working skill definition |
| Runtime surface matrix | `phase-0/compatibility/runtime-surface-matrix.yaml` | Documented facts per runtime, V1-V7 |
| Risk register | `phase-0/compatibility/risks.yaml` | 7 risks with severity, evidence, fallback |
| Acceptance gates | `phase-0/compatibility/acceptance-gates.yaml` | 18 gates (G1-G18) |
| Install guide | `phase-0/install-guide.md` | Manual installation steps |
...
See `docs/phase-0/runtime-verification.md` for step-by-step testing instructions.
