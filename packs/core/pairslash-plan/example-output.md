...
9. Record the result in
   `docs/compatibility/runtime-surface-matrix.yaml` under V1 and V4.
...
| `docs/compatibility/runtime-surface-matrix.yaml` | Update V1, V4 status | Certain |

No source files in `packs/core/pairslash-plan/` should be modified.
