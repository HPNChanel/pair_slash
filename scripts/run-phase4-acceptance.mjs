...
import { formatPhase4AcceptanceText, runPhase4Acceptance } from "@pairslash/compat-lab";
...
function printUsage() {
  console.log(
    [
      "Usage:",
      "  node scripts/run-phase4-acceptance.mjs [--lane macos|linux|windows-prep|all] [--format text|json] [--report-out path]",
      "",
      "Defaults:",
      "  --lane all",
      "  --format text",
...
try {
  ...
  if (options.format === "json") {
    ...
    process.stdout.write(formatPhase4AcceptanceText(report));
  }
