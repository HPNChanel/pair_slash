...
export function writeCaseStudySourceRecords({ repoRoot = process.cwd(), runIds = null }: any = {}) {
...
export function renderCaseStudyArtifacts({ repoRoot = process.cwd(), runIds = null }: any = {}) {
  const paths = buildPhase19Paths(repoRoot);
