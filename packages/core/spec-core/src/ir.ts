...
import { validateNormalizedIr } from "./validate.ts";

function buildRuntimeSupport(manifest: any) {
  return Object.fromEntries(
    Object.entries(manifest.runtime_bindings).map(([runtime, binding]: [string, any]) => [
      runtime,
      {
