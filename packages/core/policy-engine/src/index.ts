...
import { buildPolicyExplanation, explainPolicyVerdict } from "./explain.ts";
import { POLICY_ENGINE_ERROR_CODES } from "./error-codes.ts";
import { deriveRiskProfile, hasRisk } from "./risk-profile.ts";
import { buildRuntimeEnforcementContext } from "./runtime-context.ts";
...
function buildFailClosedVerdict({ contract, request = {}, errors }: any) {
...
export function evaluatePolicy({ contract, request = {} }: any = {}) {
