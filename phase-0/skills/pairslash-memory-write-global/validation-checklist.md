...
- [ ] `phase-0/skills/pairslash-memory-write-global/SKILL.md` exists
...
- [ ] `phase-0/specs/pairslash-memory-write-global.spec.yaml` exists and parses as valid YAML
- [ ] `phase-0/schemas/memory-record.schema.yaml` exists and parses as valid YAML
...
- [ ] `cp -r phase-0/skills/pairslash-memory-write-global .agents/skills/` succeeds (Codex CLI)
  OR
  `cp -r phase-0/skills/pairslash-memory-write-global .github/skills/` succeeds (Copilot CLI)
