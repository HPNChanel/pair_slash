...
```bash
node ../../packages/cli/src/bin/pairslash.js preview install pairslash-backend --runtime codex --target repo
node ../../packages/cli/src/bin/pairslash.js doctor --runtime codex --target repo --packs pairslash-backend
```
